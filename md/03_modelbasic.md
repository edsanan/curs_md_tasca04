...
> **Avís:**
> **No utilitzeu variables globals mutables.**
...
> **Nota:**
> **Objectiu**: al final d'aquesta secció, s'hauria d'haver creat la taula `estate_property`:
>
> ```text
> $ psql -d rd-demo
...
> **Exercici: Definiu el model de propietats immobiliàries.**
>
...
> **Exercici: Afegiu una descripció.**
>
...
> **Nota:**
> **Objectiu**: al final d'aquesta secció, s'haurien d'haver afegit diversos camps bàsics a la taula `estate_property`:
>
> ```text
> $ psql -d rd-demo
>
...
> **Exercici: Afegiu camps bàsics a la taula Propietat Immobiliària.**
>
...
> **Nota:**
> **Objectiu**: al final d'aquesta secció, les columnes `name` i `expected_price` no haurien de poder ser nul·les (not nullable) a la taula `estate_property`:
>
> ```console
> rd-demo=# \d estate_property;
>                                             Table "public.estate_property"
...
> **Exercici: Establiu atributs per a camps existents.**
>
...
**Referència**: la documentació relacionada amb aquest tema es pot trobar a [camps automàtics](reference/fields/automatic).
